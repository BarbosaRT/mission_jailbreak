...
class entity(object):
    ...
    def __init__(self, x, y, size_x, size_y, e_type):  # x, y, size_x, size_y, type
        ...
        self.action_timer = 0
        self.action = ''  # overall action for the entity
...
def animation_sequence(sequence, base_path, colorkey=(255, 255, 255), transparency=255):
    ...
    for frame in sequence:
        ...
        try:
            ...
            print(f'File {image_id + ".png"} not found')
...
def load_particle_images(path):
    ...
    for folder in file_list:
        try:
            ...
            images = []
            for img in img_list:
                images.append(pygame.image.load(path + '/' + folder + '/' + img).convert_alpha())
            """for img in images:
